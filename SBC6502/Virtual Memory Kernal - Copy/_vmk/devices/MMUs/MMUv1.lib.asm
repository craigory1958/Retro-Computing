...
__mmu_instantiate  .macro  list, numBitsPID, numBitsVirtualAddr, numBitsPhysicalAddr, numBitsSegmentOffset
                    ${list}
...
__mmu_map_segment  .macro  list, pid, physicalAddress, effectiveAddress
                    ${list}
