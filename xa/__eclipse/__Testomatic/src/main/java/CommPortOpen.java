...
class PortChooser extends JDialog implements ItemListener {
	...
	/**
	 * Populate the ComboBoxes by asking the Java Communications API what ports it has. Since the initial information comes from a Properties file, it may not
	 * exactly reflect your hardware.
	 */
