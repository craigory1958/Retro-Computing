...
public class _Test_XA_LIST {
	...
	private static final Logger Logger = LoggerFactory.getLogger(_Test_XA_LIST.class) ;

	String desc ;
	String srcFSpec ;


	public _Test_XA_LIST(final String desc, final String srcFSpec) {
