...
public class _Test_XA_BYTE {
	...
	private static final Logger Logger = LoggerFactory.getLogger(_Test_XA_BYTE.class) ;

	String desc ;
	String srcFSpec ;


	public _Test_XA_BYTE(final String desc, final String srcFSpec) {
