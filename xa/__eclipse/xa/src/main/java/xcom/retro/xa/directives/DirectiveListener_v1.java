...
public class DirectiveListener_v1 extends DirectivesBaseListener {

	AssemblyContext actx ;


	public DirectiveListener_v1(final AssemblyContext actx) {
		this.actx = actx ;
	}
	...
	@NoLog
	public void exitDefinedDirective(final ParserRuleContext pctx) {
