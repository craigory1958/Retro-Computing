...
@aProcessor(lexar = MOS6502_Lexer.class, parser = MOS6502_Parser.class, processor = MOS6502_v1.class)
public class MOS6502_v1 extends MOS6502_BaseListener implements iProcessor {
	...
	public MOS6502_v1(final AssemblyContext actx) {
		this.actx = actx ;
	}
