...
public class XA {
	...
	XA init() throws Exception {
		...
		{
//			final Annotation processor = processors.get(actx.cmdArgs.get(CommandLineOption_Processor)).getAnnotation(aProcessor.class) ;
...
//			final String lexerClassname = processor.lexar().getName() ;
...
//			final String parserClassname = processor.parser().getSimpleName().substring(6) ;
...
//			final String listenerClassname = processor.listener().getSimpleName() ;
